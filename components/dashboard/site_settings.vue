...
export default {
  ...
  data() {
    return {
      ...
      weekly_stats_avg: 0,
      weekly_stats_highest: 'Kinda quiet round here...',
      weekly_chart: 'line',
      hourly_stats_data: [1],
      hourly_data_collection: null,
      hourly_stats_labels: ['a'],
      hourly_stats_avg: 0,
      hourly_stats_highest: 'Kinda quiet round here...',
      hourly_chart: 'line',
      monthly_stats_data: [1],
      monthly_data_collection: null,
      monthly_stats_labels: ['a'],
      monthly_stats_avg: 0,
      monthly_stats_highest: 'Kinda quiet round here...',
      monthly_chart: 'line',
  ...
  computed: {
    ...
    //       data: this.weekly_stats_data
    //     }
    //   }
    //   return this.weekly_data_collection
    // }
  },
  mounted() {
  ...
  <v-layout class="flipped-section d-flex flex-column px-4 py-9">
    ...
    >
      <div class="flipped-header-back-btn">
        <v-btn elevation="2" rounded color="info" @click="flip('main')">
          Back
        </v-btn>
      </div>
