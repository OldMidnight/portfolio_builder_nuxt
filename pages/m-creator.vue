...
export default {
  ...
  mounted() {
    // this.layoutSlideWidth =
    //   document.getElementById('layouts-slide-group').children[1].offsetWidth -
    //   10
...
<template>
  <v-row :class="`ma-0 w-100 ${checkStepCount(1) ? 'h-100' : 'h-90'} pos-rel`">
    <transition
      appear
      ...
      mode="out-in"
    >
      <v-col v-if="checkStepCount(0)" cols="12" class="py-0 px-9">
        <div class="w-100 h-5">
          <p class="text-center ma-0">Swipe and Select a Layout!</p>
        </div>
      ...
      >
        <v-row class="ma-0 h-100 w-100">
          <v-col
            cols="12"
            class="h-50 pa-0 elevation-1 d-flex justify-center align-center"
          >
            <transition
              enter-active-class="animated fadeIn faster"
              leave-active-class="animated fadeOut faster"
          ...
          <v-col
            cols="12"
            class="h-50 elevation-1 pa-0 d-flex text-center flex-column justify-center align-center px-4"
          >
            <p class="subtitle-1">Info</p>
            <p :class="`${$vuetify.breakpoint.smAndDown ? 'caption' : ''}`">
            ...
            <v-row class="creation-name--preview w-100 ma-0 elevation-1 mt-4">
              <v-col
                cols="12"
                class="creation-name--preview-tabs d-flex align-end pa-0 px-1 h-50"
              >
                <div
    ...
    <v-navigation-drawer
      ...
      bottom
      temporary
      class="creator-tools-drawer d-flex flex-column align-center"
    >
