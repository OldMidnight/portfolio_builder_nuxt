          ...
          <v-layout align-center class="preview-page-wrapper">
            ...
            >
              <v-layout column class="preview-2-sidenav">
                <v-flex
                  v-for="main_page_option in mandatory_page_options"
                  :key="main_page_option.id"
            ...
            >
              ...
              <v-layout class="preview-3-bottom-nav">
                <v-flex
                  v-for="main_page_option in mandatory_page_options"
                  :key="main_page_option.id"
                  class="preview-3-bottom-nav-itemoption"
                  :class="{
                    'round-corner-bottom-right':
                      main_page_option.id === mandatory_page_options.length,
                    'round-corner-bottom-left': main_page_option.id === 1
                  }"
                ></v-flex>
              </v-layout>
            </v-layout>
